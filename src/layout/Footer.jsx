          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 justify-between">
            ...
            <div className="max-w-full lg:max-w-[551px]">
              ...
              <p className="text-base sm:text-lg font-medium text-white">
                At Hometown Hero, our mission is to empower athletes with a
                bold, AI-driven platform built to unlock real growth and real
                NIL earnings. We’re hands-on every step of the way — from
                launching your brand to building your audience, locking in
                deals, and scaling your success. With the highest profit share
                in the game and tools designed for creators who hustle, we make
                it easy for athletes to own their story, monetize their name,
                and turn their grind into long-term greatness.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-10 justify-between w-full lg:max-w-[600px]">
              ...
              <div className="min-w-[120px]">
                <h4 className="text-lg font-medium text-[#D4BC6D] mb-6">
                  Explore
                </h4>
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-400 text-sm">
                      Info@hometownheroagency.com
                    </span>
                  </div>

                  {/* <div>
                                        <a 
                                            href="mailto:Info@hometownheroagency.com" 
                                            className="text-base font-semibold text-white capitalize"
                                        >
                                           For Support and Inquiries
                                        </a>
                                        mailto:Info@hometownheroagency.com
                                    </div> */}

                  <div className="text-base font-semibold text-white capitalize cursor-pointer"
                    onClick={() => {
                      if (window.zE) {
