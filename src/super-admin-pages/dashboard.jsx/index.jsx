            ...
            <div className="gap-6 mb-8 max-w-screen">
                <div className="card-gradient border-[1.5px] p-6 rounded-3xl">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-green-400 text-sm font-semibold">+{data?.total_sale_percentage}%</span>
                    </div>
                    <div>
                        <p className="text-[#838383] text-sm font-medium mb-1">Total Sales</p>
                        <h3 className="text-2xl font-bold text-[#D4BC6D]">${data?.total_sale}</h3>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                            ...
                            {salesData.map((datas, index) => (
                                <div key={index} className="flex-1 flex flex-col items-center group relative">
                                    ...
                                    <div className="mt-2 text-center">
                                        <div className="text-white text-sm font-medium">{datas.day}</div>
                                        <div className="text-[#838383] text-xs">{datas.label}</div>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <div className="card-gradient border-[1.5px] p-6 rounded-3xl">
                    ...
                    <div className="space-y-4">
                        ...
                        ) : <p className='text-[#ddd]'>No products found.</p>}
