    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="bg-[#282828] border border-[#4B4C46] rounded-lg p-4 sm:p-6">
        ...
        {/* Controls */}
        <div className="bg-[#282828] border border-[#4B4C46] rounded-lg p-4 sm:p-6 mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="w-full sm:w-auto">
                <select
                  ...
                  className="w-full sm:w-auto px-4 py-2 bg-[#1a1a1a] border border-[#4B4C46] rounded-lg text-white focus:outline-none focus:border-[#D4BC6D]"
                >
            ...
            <div className="flex justify-end">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#D4BC6D] text-black rounded-lg hover:bg-[#E6C977] transition-colors w-full sm:w-auto justify-center"
              >
        ...
        <div className="bg-[#282828] border border-[#4B4C46] rounded-lg overflow-hidden">
          ...
          <div className="md:hidden">
            {filteredUsers?.map((user) => (
              <div key={user.id} className="p-4 border-b border-[#4B4C46] last:border-b-0">
                ...
                <div className="flex items-center justify-end space-x-2 pt-2 border-t border-[#4B4C46]">
                  <button
                    onClick={() => handleViewUser(user)}
                    className="p-2 text-gray-400 hover:text-[#D4BC6D] transition-colors"
                    title="View User"
...
const AddUserModal = ({ isOpen, onClose, users, setUsers }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-[#282828] border border-[#4B4C46] rounded-lg p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
...
const DeleteUserModal = ({ isOpen, onClose, user, users, setUsers }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-[#282828] border border-[#4B4C46] rounded-lg p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        <h2 className="text-lg sm:text-xl font-bold text-red-400 mb-4">Delete User</h2>
