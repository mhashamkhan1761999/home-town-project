...
const SuperAdminProducts = () => {
    ...
    const fallbackProducts = [
        ...
        },
        {
            ...
            description: "Warm and comfortable hoodie perfect for sports and casual wear",
            price: 45.99,
            stock: 75,
            status: "active",
            image: "shirt.svg",
        ...
        <div className="card-gradient !border-[1.5px] p-6 rounded-3xl">
            ...
            <div className="flex gap-4 mb-6">
                <div className="relative flex-1">
                    <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#838383]" size={20} />
                    <input
                        type="text"
                    ...
                    <tbody>
                        {isLoading ? (
                            ...
                            paginatedProducts.map((product) => (
                                <tr key={product.id} className="border-b border-[#323232] hover:bg-[rgba(255,255,255,0.02)]">
                                    <td className="py-4">
                                        <div className="w-12 h-12 bg-[#282828] rounded-lg overflow-hidden">
                                            {product.image ? (
                                                <img
                                                    src={error ? `/${product.image}` : `https://hometown.eagleeblaze.com/storage/app/public/${product.image}`}
                                                    alt={product.name}
                                            ...
                                            <div className={`w-full h-full flex items-center justify-center text-[#838383] ${product.image ? 'hidden' : ''}`}>
                                                <Package size={20} />
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="py-4 text-[#D4BC6D]">{product.category?.name || 'N/A'}</td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-black border border-[#4B4C46] rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    {/* Colors */}
                    <div>
                        <label className="block text-white font-medium mb-2">Available Colors</label>
                        <Select
                            isMulti
