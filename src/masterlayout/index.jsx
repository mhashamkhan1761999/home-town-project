  ...
  return (
    <>
        ...
        <div className="hidden md:flex w-[10rem] min-w-[10rem] max-w-[10rem] h-full flex-col bg-black card-gradient !border-[1.5px] rounded-3xl">
          ...
          <div className="flex-shrink-0">
            <img
              src="/admin-logo.svg"
              alt="Logo"
              className="w-[4.438rem] h-auto mt-6 mx-auto"
            />
            ...
            <div className="mt-6 mb-4 flex flex-col justify-center items-center gap-3">
              ...
              <NavLink
                to="/athlete/profile"
                className="text-[#6A6A69] z-40 font-bold text-base"
              >
                Edit Profile
              </NavLink>
            </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-start gap-6 overflow-y-auto custom-scrollbar px-2 pb-4">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "text-[#CAB265] font-bold text-base flex flex-col items-center gap-2 text-center"
                  : "text-[#6A6A69] font-bold text-base flex items-center gap-2 text-center flex-col"
              }
            >
              <Layers size={18} />
              My Products
          ...
          <div className="w-full p-4 flex items-center">
            ...
            <div className="hidden md:flex items-center w-full">
              ...
              <div className="flex items-center justify-end grow gap-5">
                ...
                <div
                  className="relative w-[4.563rem] h-[4.563rem] cursor-pointer group" // your onClick handler
                  onClick={() => {
                    if (window.zE) {
                      window.zE("messenger", "open");
                    } else {
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div
            className="fixed top-0 left-0 h-full w-80 bg-black card-gradient border-r-[1.5px] p-4 z-[10000]"
          ...
          >
            ...
            <div className="flex flex-col items-center mb-6">
              ...
              <div className="text-center">
                ...
                <div className="text-[#D4BC6D] font-bold mb-1">
                  {user?.badge_level?.name || "Bronze"}
                </div>
      ...
      {isShow2 && <AdminModal2 onClose={() => setIsShow2(false)} />}
    </>
  );
};
